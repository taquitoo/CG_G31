...
function animateCraneAndLoad(loadMesh) {
	/*FIXME
	 * Everytime this animation ends, the Bloco ends up in a wrong position,
	 * separate from the Cabo
	 * This is happening because the Cabo length isn't getting updated after the animation,
	 * whereas other pieces like the Bloco are, thus the misplacement.
	 */
    ...
    var finalTopoRotation = Math.atan2(deltaY, deltaX);
